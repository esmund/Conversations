...
import eu.siacs.conversations.ui.camera.CameraSource;
import eu.siacs.conversations.ui.camera.CameraSourcePreview;
import eu.siacs.conversations.ui.camera.GraphicOverlay;

import static android.app.Activity.RESULT_OK;

public class BarcodePreviewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_barcode_preview, container, false);
    ...
    private boolean onTap(float rawX, float rawY) {
        ...
        for (BarcodeGraphic graphic : mGraphicOverlay.getGraphics()) {
            ...
            if (barcode.getBoundingBox().contains((int) x, (int) y)) {
                ...
                best = barcode;
                Log.d("debug","barcode is "+best.displayValue);
                return true;
                //break;
            }
        ...
        if (best != null) {
                Log.d(TAG, "Barcode read: " + best.displayValue);
            } else {
    ...
    private void startCameraSource() throws SecurityException {
        ...
        if (mCameraSource != null) {
            try {
                ...
                Log.d("debug","BarcodePreviewFragment mCameraSource ran");
            } catch (IOException e) {
